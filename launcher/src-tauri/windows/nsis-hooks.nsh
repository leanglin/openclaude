!macro NSIS_HOOK_PREINSTALL
  ...
  FileWrite $1 "foreach ($$processId in $$ids) {$\r$\n"
  FileWrite $1 "  Write-Output ('Stopping OpenCat backend PID ' + $$processId)$\r$\n"
  FileWrite $1 "  Stop-Process -Id $$processId -Force -ErrorAction Stop$\r$\n"
  FileWrite $1 "}$\r$\n"
