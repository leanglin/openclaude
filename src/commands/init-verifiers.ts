...
**All verifier skills are created in the project root's \`.opencat/skills/\` directory.** This ensures they are automatically loaded when OpenCat runs in the project.

Write the skill file to \`.opencat/skills/<verifier-name>/SKILL.md\`.
...
1. Where each skill was created (always in \`.opencat/skills/\`)
