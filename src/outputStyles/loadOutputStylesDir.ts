...
/**
 * Loads markdown files from .opencat/output-styles directories throughout the project
 * and from the user output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .opencat/output-styles/*.md -> project styles
 * - User output-styles/*.md -> user styles (overridden by project styles)
 *
